...
const HomePageWhatIsNutura = () => {
  return (
    <div className="min-h-[500px] xl:min-h-[700px] 2xl:min-h-[900px] flex flex-col justify-center w-full  section_space border-secondary border rounded-[20px] relative p-8 md:p-16 ">
