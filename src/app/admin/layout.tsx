...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-row">
      <div className="flex flex-col w-[350px] bg-tertiary  items-center relative">
        <Image
          src={"/logo_green.svg"}
          alt="logo"
          width={80}
        ...
        <div className="flex flex-col mt-16 gap-4">
          ...
          <Link href={"/admin/produkty"}>
            <h6
              className={`text-secondary ${
                pathname.startsWith("/admin/produkty") && "!font-bold underline"
              }`}
            >
              Produkty
            </h6>
        ...
        <button
          ...
          className="text-black !font-semibold cursor-pointer btn btn--secondary !mt-[35rem] !mb-8 "
        >
          Odhlásiť sa
        </button>
      </div>
